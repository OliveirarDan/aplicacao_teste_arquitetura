...
CREATE TABLE IF NOT EXISTS `alfapidb`.`Pais` (
...
-- -----------------------------------------------------
-- Table `alfapidb`.`Estado`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `alfapidb`.`Estado` ;

CREATE TABLE IF NOT EXISTS `alfapidb`.`Estado` (
  ...
  CONSTRAINT `fk_Estado_Pais1`
    ...
    REFERENCES `alfapidb`.`Pais` (`idPais`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `alfapidb`.`Cidade`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `alfapidb`.`Cidade` ;

CREATE TABLE IF NOT EXISTS `alfapidb`.`Cidade` (
  ...
  CONSTRAINT `fk_Cidade_Estado1`
    ...
    REFERENCES `alfapidb`.`Estado` (`idEstado`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `alfapidb`.`Endereco` ;
...
CREATE TABLE IF NOT EXISTS `alfapidb`.`Endereco` (
  ...
  CONSTRAINT `fk_Endereco_Cidade1`
    ...
    REFERENCES `alfapidb`.`Cidade` (`idCidade`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Endereco_Pessoa1`
    FOREIGN KEY (`Pessoa_idPessoa`)
    REFERENCES `alfapidb`.`Pessoa` (`idPessoa`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
